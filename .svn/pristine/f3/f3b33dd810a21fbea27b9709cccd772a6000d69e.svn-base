...
public class RotmilanTemp implements Player{
	...
	public Move nextMove() {
		...
		switch(situation) {
			...
			//case 1: return ; 									// wenn die Tore noch nicht geschützt sind
			//case 2: return 				  					// eigene Tore sind geschützt, eigene Steine können zu den Toren laufen
			//case 3: return 				  					//mind ein eigner Stein steht vor dem geschützten Tor, austausch
			//case 4: return				 					//wenn die gegnerischen Tore angegriffen werden können
