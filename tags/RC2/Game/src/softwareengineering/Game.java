...
public class Game {
	...
	public static void main(String[] args) {
		...
		//game.addPlayer(new RandomPlayer(1, "Player1", game));
		//game.addPlayer(new RandomPlayer(2, "Player2", game));
//		game.addPlayer(new RandomPlayer(3, "Player3", game));
		...
		//game.addPlayer(new Rotmilan(4, "Rotmilan", game));
		game.addPlayer(new RotmilanNeu(1, "Rotmilan", game));
